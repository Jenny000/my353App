package com.wang.inis.PostComment.Entity;
...
public class Comment implements Serializable {
    ...
    @ElementCollection
    @CollectionTable(name = "child_list")
    ...
    public Comment(@NotEmpty(message = "comment can not be empty") @Size(max = 500, message = "max words 500") String content,
    ...
    public Comment(@NotEmpty(message = "comment can not be empty") @Size(max = 500, message = "max words 500") String content,
                   Date createTime, String nikeName, String title, String parentId, List<Comment> childCommentList, String ip){
        this.content = content;
        this.createTime = createTime;
        this.nikeName = nikeName;
        this.title = title;
